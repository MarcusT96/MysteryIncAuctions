...
app.MapPost("/categories", async (CategoryOptions.Category newCategory) => await CategoryOptions.CreateCategory(newCategory));
app.MapPut("/categories/{id:int}", async (int id, CategoryOptions.Category updatedCategory) => await CategoryOptions.UpdateCategory(id, updatedCategory));
